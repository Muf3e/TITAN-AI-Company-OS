...
async function createCheckoutSession({ orderId, name, description, amount, currency = 'inr', successUrl, cancelUrl, customerEmail = null }) {
  ...
  const params = {
    ...
    'custom_fields[0][label][custom]': 'Business or brand name',
    'custom_fields[0][type]': 'text',
    'custom_fields[0][optional]': 'false',
    'custom_fields[1][key]': 'website',
    'custom_fields[1][label][type]': 'custom',
    'custom_fields[1][label][custom]': 'Website (optional)',
    'custom_fields[1][type]': 'text',
    'custom_fields[1][optional]': 'true',
    'custom_fields[2][key]': 'main_goal',
    'custom_fields[2][label][type]': 'custom',
    'custom_fields[2][label][custom]': 'What do you want to automate?',
